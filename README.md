...
9. Create a SMTP logging into [https://app.elasticemail.com/](https://app.elasticemail.com/login) and generating a secure token through [https://smtpjs.com/](https://smtpjs.com/) 
